...
class JuradoViewSet(viewsets.ModelViewSet):
    ...
    def editar_jurado(self, request, pk):
        ...
        if verificarToken.validarRol(request) is True:
            ...
            if nueva_imagen and jurado.image_r2 and nueva_imagen != jurado.image_r2:
                imagen_anterior = jurado.image_r2
            ...
            if nuevo_archivo and jurado.file_r2 and nuevo_archivo != jurado.file_r2:
                archivo_anterior = jurado.file_r2
            ...
            serializer = JuradoSerializer(jurado, data=data, partial=True)
            if serializer.is_valid():
                serializer.save()
