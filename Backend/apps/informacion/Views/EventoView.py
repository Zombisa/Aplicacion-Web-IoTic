...
class EventoViewSet(viewsets.ModelViewSet):
    ...
    def editar_evento(self, request, pk):
        ...
        if verificarToken.validarRol(request) is True:
            ...
            if nueva_imagen and evento.image_r2 and nueva_imagen != evento.image_r2:
                imagen_anterior = evento.image_r2
            ...
            if nuevo_archivo and evento.file_r2 and nuevo_archivo != evento.file_r2:
                archivo_anterior = evento.file_r2
    ...
    def eliminar_evento(self, request, pk):
        ...
        if verificarToken.validarRol(request) is True:
            ...
            image_path = evento.image_r2.split("/")[-1]
