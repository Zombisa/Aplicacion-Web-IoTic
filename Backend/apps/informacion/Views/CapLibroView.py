...
class CapLibroViewSet(viewsets.ModelViewSet):
    ...
    def editar_capitulo_libro(self, request, pk):
        ...
        if verificarToken.validarRol(request) is True:
            ...
            if nueva_imagen and cap_libro.image_r2 and nueva_imagen != cap_libro.image_r2:
                imagen_anterior = cap_libro.image_r2
            ...
            if nuevo_archivo and cap_libro.file_r2 and nuevo_archivo != cap_libro.file_r2:
                archivo_anterior = cap_libro.file_r2
            ...
            serializer = CapLibroSerializer(cap_libro, data=data, partial=True)
            if serializer.is_valid():
                serializer.save()
