...
class ParticipacionComitesEvViewSet(viewsets.ModelViewSet):
    ...
    def editar_comite_ev(self, request, pk):
        ...
        if verificarToken.validarRol(request) is True:
            ...
            if nueva_imagen and comite_ev.image_r2 and nueva_imagen != comite_ev.image_r2:
                imagen_anterior = comite_ev.image_r2
            ...
            if nuevo_archivo and comite_ev.file_r2 and nuevo_archivo != comite_ev.file_r2:
                archivo_anterior = comite_ev.file_r2
            ...
            serializer = ParticipacionComitesEvSerializer(comite_ev, data=data, partial=True)
            if serializer.is_valid():
                serializer.save()
