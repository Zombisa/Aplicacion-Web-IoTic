...
export const routes: Routes = [
     ...
     { path: 'inventario/add-item', component: AddItem, canActivate: [AuthGuard, AdminGuard] },
     { path: 'inventario/add-loan/:id', component: AddLoan, canActivate: [AuthGuard, AdminGuard, ItemAvailableGuard] },
     { path: 'inventario/view-item/:id', component: ViewItem, canActivate: [AuthGuard, AdminGuard] },
     { path: 'inventario/edit-item/:id', component: EditItem, canActivate: [AuthGuard, AdminGuard] },
     { path: 'prestamos/pretamo/:id', component: ViewLoanItem, canActivate: [AuthGuard, AdminGuard] },
     { path: 'inventario/history', component: ViewHistoryLoan, canActivate: [AuthGuard, AdminGuard] },
